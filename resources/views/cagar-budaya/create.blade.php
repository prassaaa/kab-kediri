                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('lokasi_jalan_dukuhan') }}" 
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm sm:text-base">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('no_reg_disparbud_nomor_urut') }}" 
                                               class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm sm:text-base">
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('no_reg_disparbud_kode_kecamatan') }}" 
                                               class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm sm:text-base">
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('no_reg_disparbud_kode_kabupaten') }}" 
                                               class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm sm:text-base">
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('no_reg_disparbud_tahun') }}" 
                                               class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm sm:text-base">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea name="kondisi_saat_ini" 
                                          id="kondisi_saat_ini" 
                                          rows="5" 
                                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm sm:text-base">{{ old('kondisi_saat_ini') }}</textarea>
