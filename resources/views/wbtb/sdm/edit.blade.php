...
@section('page-title', 'Edit SDM Kebudayaan')
...
<div class="bg-white overflow-hidden shadow-sm rounded-lg">
    <div class="p-6">
        ...
        <form action="{{ route('wbtb.sdm.update', $sdm->id) }}" method="POST" enctype="multipart/form-data" id="sdm-form">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap', $sdm->nama_lengkap) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('nama_lengkap')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="gelar_pendidikan" id="gelar_pendidikan" value="{{ old('gelar_pendidikan', $sdm->gelar_pendidikan) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_alias" id="nama_alias" value="{{ old('nama_alias', $sdm->nama_alias) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('nama_alias')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="jenis_identitas" id="jenis_identitas" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                ...
                                <option value="KTP" {{ old('jenis_identitas', $sdm->jenis_identitas) == 'KTP' ? 'selected' : '' }}>KTP</option>
                                <option value="Paspor" {{ old('jenis_identitas', $sdm->jenis_identitas) == 'Paspor' ? 'selected' : '' }}>Paspor</option>
                                <option value="SIM" {{ old('jenis_identitas', $sdm->jenis_identitas) == 'SIM' ? 'selected' : '' }}>SIM</option>
                                <option value="Kartu Pelajar" {{ old('jenis_identitas', $sdm->jenis_identitas) == 'Kartu Pelajar' ? 'selected' : '' }}>Kartu Pelajar</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nomor_identitas" id="nomor_identitas" value="{{ old('nomor_identitas', $sdm->nomor_identitas) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir', $sdm->tempat_lahir) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('tempat_lahir')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="kewarganegaraan" id="kewarganegaraan" value="{{ old('kewarganegaraan', $sdm->kewarganegaraan) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $sdm->tanggal_lahir) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('tanggal_lahir')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="jenis_kelamin" id="jenis_kelamin" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                ...
                                <option value="Laki-laki" {{ old('jenis_kelamin', $sdm->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="Perempuan" {{ old('jenis_kelamin', $sdm->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                            @error('jenis_kelamin')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <select name="agama" id="agama" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                ...
                                <option value="Islam" {{ old('agama', $sdm->agama) == 'Islam' ? 'selected' : '' }}>Islam</option>
                                <option value="Kristen Protestan" {{ old('agama', $sdm->agama) == 'Kristen Protestan' ? 'selected' : '' }}>Kristen Protestan</option>
                                <option value="Katolik" {{ old('agama', $sdm->agama) == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                                <option value="Hindu" {{ old('agama', $sdm->agama) == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                                <option value="Buddha" {{ old('agama', $sdm->agama) == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                                <option value="Konghucu" {{ old('agama', $sdm->agama) == 'Konghucu' ? 'selected' : '' }}>Konghucu</option>
                                <option value="Lainnya" {{ old('agama', $sdm->agama) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                            @error('agama')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            @if($sdm->pas_foto)
                                <img src="{{ asset('storage/' . $sdm->pas_foto) }}" alt="Pas Foto" class="w-32 h-32 object-cover mb-2">
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            @if($sdm->foto_identitas)
                                <img src="{{ asset('storage/' . $sdm->foto_identitas) }}" alt="Foto Identitas" class="w-32 h-32 object-cover mb-2">
                            @endif
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>{{ old('alamat', $sdm->alamat) }}</textarea>
                            @error('alamat')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-2">
                                <div>
                                    ...
                                    <input type="text" name="latitude" id="latitude" value="{{ old('latitude', $sdm->latitude) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    @error('latitude')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="longitude" id="longitude" value="{{ old('longitude', $sdm->longitude) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    @error('longitude')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nomor_hp" id="nomor_hp" value="{{ old('nomor_hp', $sdm->nomor_hp) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('nomor_hp')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_ayah" id="nama_ayah" value="{{ old('nama_ayah', $sdm->nama_ayah) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('nama_ayah')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_ibu" id="nama_ibu" value="{{ old('nama_ibu', $sdm->nama_ibu) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('nama_ibu')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $sdm->email) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('email')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="media_sosial" id="media_sosial" value="{{ old('media_sosial', $sdm->media_sosial) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Instagram: @username, Facebook: nama.akun">
                            @error('media_sosial')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4" id="riwayat-pendidikan-container">
                            ...
                            <div class="riwayat-pendidikan-items space-y-2">
                                @forelse($sdm->riwayat_pendidikan as $index => $pendidikan)
                                    <div class="riwayat-pendidikan-item p-3 border border-gray-300 rounded-md">
                                        <div class="grid grid-cols-2 gap-2 mb-2">
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Tahun</label>
                                                <input type="text" name="riwayat_pendidikan[{{$index}}][tahun]" value="{{ old('riwayat_pendidikan.' . $index . '.tahun', $pendidikan['tahun']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="2010-2014">
                                            </div>
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Jenjang</label>
                                                <input type="text" name="riwayat_pendidikan[{{$index}}][jenjang]" value="{{ old('riwayat_pendidikan.' . $index . '.jenjang', $pendidikan['jenjang']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="S1/SMA/dll">
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="block text-xs text-gray-500 mb-1">Institusi</label>
                                            <input type="text" name="riwayat_pendidikan[{{$index}}][institusi]" value="{{ old('riwayat_pendidikan.' . $index . '.institusi', $pendidikan['institusi']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama institusi pendidikan">
                                        </div>
                                        <div>
                                            <label class="block text-xs text-gray-500 mb-1">Jurusan/Program Studi</label>
                                            <input type="text" name="riwayat_pendidikan[{{$index}}][jurusan]" value="{{ old('riwayat_pendidikan.' . $index . '.jurusan', $pendidikan['jurusan']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama jurusan/program studi">
                                        </div>
                                    </div>
                                @empty
                                    <div class="riwayat-pendidikan-item p-3 border border-gray-300 rounded-md">
                        ...
                        <div class="mb-4" id="riwayat-pelatihan-container">
                            ...
                            <div class="riwayat-pelatihan-items space-y-2">
                                @forelse($sdm->riwayat_pelatihan as $index => $pelatihan)
                                    <div class="riwayat-pelatihan-item p-3 border border-gray-300 rounded-md">
                                        <div class="grid grid-cols-2 gap-2 mb-2">
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Tahun</label>
                                                <input type="text" name="riwayat_pelatihan[{{$index}}][tahun]" value="{{ old('riwayat_pelatihan.' . $index . '.tahun', $pelatihan['tahun']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="2020">
                                            </div>
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Durasi</label>
                                                <input type="text" name="riwayat_pelatihan[{{$index}}][durasi]" value="{{ old('riwayat_pelatihan.' . $index . '.durasi', $pelatihan['durasi']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="3 bulan">
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="block text-xs text-gray-500 mb-1">Nama Pelatihan</label>
                                            <input type="text" name="riwayat_pelatihan[{{$index}}][nama]" value="{{ old('riwayat_pelatihan.' . $index . '.nama', $pelatihan['nama']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama pelatihan">
                                        </div>
                                        <div>
                                            <label class="block text-xs text-gray-500 mb-1">Penyelenggara</label>
                                            <input type="text" name="riwayat_pelatihan[{{$index}}][penyelenggara]" value="{{ old('riwayat_pelatihan.' . $index . '.penyelenggara', $pelatihan['penyelenggara']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama penyelenggara">
                                        </div>
                                    </div>
                                @empty
                                    <div class="riwayat-pelatihan-item p-3 border border-gray-300 rounded-md">
                        ...
                        <div class="mb-4" id="riwayat-pekerjaan-container">
                            ...
                            <div class="riwayat-pekerjaan-items space-y-2">
                                @forelse($sdm->riwayat_pekerjaan as $index => $pekerjaan)
                                    <div class="riwayat-pekerjaan-item p-3 border border-gray-300 rounded-md">
                                        <div class="grid grid-cols-2 gap-2 mb-2">
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Tahun</label>
                                                <input type="text" name="riwayat_pekerjaan[{{$index}}][tahun]" value="{{ old('riwayat_pekerjaan.' . $index . '.tahun', $pekerjaan['tahun']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="2015-2020">
                                            </div>
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Posisi/Jabatan</label>
                                                <input type="text" name="riwayat_pekerjaan[{{$index}}][posisi]" value="{{ old('riwayat_pekerjaan.' . $index . '.posisi', $pekerjaan['posisi']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Posisi/Jabatan">
                                            </div>
                                        </div>
                                        <div>
                                            <label class="block text-xs text-gray-500 mb-1">Perusahaan/Instansi</label>
                                            <input type="text" name="riwayat_pekerjaan[{{$index}}][instansi]" value="{{ old('riwayat_pekerjaan.' . $index . '.instansi', $pekerjaan['instansi']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama perusahaan/instansi">
                                        </div>
                                    </div>
                                @empty
                                    <div class="riwayat-pekerjaan-item p-3 border border-gray-300 rounded-md">
                        ...
                        <div class="mb-4" id="riwayat-aktivitas-container">
                            ...
                            <div class="riwayat-aktivitas-items space-y-2">
                                @forelse($sdm->riwayat_aktivitas as $index => $aktivitas)
                                    <div class="riwayat-aktivitas-item p-3 border border-gray-300 rounded-md">
                                        <div class="grid grid-cols-2 gap-2 mb-2">
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Tahun</label>
                                                <input type="text" name="riwayat_aktivitas[{{$index}}][tahun]" value="{{ old('riwayat_aktivitas.' . $index . '.tahun', $aktivitas['tahun']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="2022">
                                            </div>
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Jenis Aktivitas</label>
                                                <input type="text" name="riwayat_aktivitas[{{$index}}][jenis]" value="{{ old('riwayat_aktivitas.' . $index . '.jenis', $aktivitas['jenis']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Pertunjukan/Workshop/dll">
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="block text-xs text-gray-500 mb-1">Nama Kegiatan</label>
                                            <input type="text" name="riwayat_aktivitas[{{$index}}][nama]" value="{{ old('riwayat_aktivitas.' . $index . '.nama', $aktivitas['nama']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama kegiatan">
                                        </div>
                                        <div>
                                            <label class="block text-xs text-gray-500 mb-1">Penyelenggara</label>
                                            <input type="text" name="riwayat_aktivitas[{{$index}}][penyelenggara]" value="{{ old('riwayat_aktivitas.' . $index . '.penyelenggara', $aktivitas['penyelenggara']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama penyelenggara">
                                        </div>
                                    </div>
                                @empty
                                    <div class="riwayat-aktivitas-item p-3 border border-gray-300 rounded-md">
                        ...
                        <div class="mb-4" id="riwayat-penghargaan-container">
                            ...
                            <div class="riwayat-penghargaan-items space-y-2">
                                @forelse($sdm->riwayat_penghargaan as $index => $penghargaan)
                                    <div class="riwayat-penghargaan-item p-3 border border-gray-300 rounded-md">
                                        <div class="grid grid-cols-2 gap-2 mb-2">
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Tahun</label>
                                                <input type="text" name="riwayat_penghargaan[{{$index}}][tahun]" value="{{ old('riwayat_penghargaan.' . $index . '.tahun', $penghargaan['tahun']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="2021">
                                            </div>
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Tingkat</label>
                                                <input type="text" name="riwayat_penghargaan[{{$index}}][tingkat]" value="{{ old('riwayat_penghargaan.' . $index . '.tingkat', $penghargaan['tingkat']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Lokal/Nasional/Internasional">
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <label class="block text-xs text-gray-500 mb-1">Nama Penghargaan</label>
                                            <input type="text" name="riwayat_penghargaan[{{$index}}][nama]" value="{{ old('riwayat_penghargaan.' . $index . '.nama', $penghargaan['nama']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama penghargaan">
                                        </div>
                                        <div>
                                            <label class="block text-xs text-gray-500 mb-1">Pemberi Penghargaan</label>
                                            <input type="text" name="riwayat_penghargaan[{{$index}}][pemberi]" value="{{ old('riwayat_penghargaan.' . $index . '.pemberi', $penghargaan['pemberi']) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama lembaga/institusi pemberi">
                                        </div>
                                    </div>
                                @empty
                                    <div class="riwayat-penghargaan-item p-3 border border-gray-300 rounded-md">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function setupRiwayatManager(type, initialCount) {
        ...
        // Setup untuk setiap jenis riwayat dengan jumlah awal dari data existing
        setupRiwayatManager('pendidikan', {{ count($sdm->riwayat_pendidikan) }});
        setupRiwayatManager('pelatihan', {{ count($sdm->riwayat_pelatihan) }});
        setupRiwayatManager('pekerjaan', {{ count($sdm->riwayat_pekerjaan) }});
        setupRiwayatManager('aktivitas', {{ count($sdm->riwayat_aktivitas) }});
        setupRiwayatManager('penghargaan', {{ count($sdm->riwayat_penghargaan) }});
    });
</script>
@endpush