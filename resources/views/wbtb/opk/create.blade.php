...
@section('page-title', 'Tambah Data OPK')
...
<div class="bg-white overflow-hidden shadow-sm rounded-lg">
    <div class="p-6">
        ...
        <form action="{{ route('wbtb.opk.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div>
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_opk" id="nama_opk" value="{{ old('nama_opk') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('nama_opk')
                        ...
                        <div class="mb-4">
                            ...
                            <select name="jenis_opk" id="jenis_opk" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                ...
                                <option value="Tradisi lisan" {{ old('jenis_opk') == 'Tradisi lisan' ? 'selected' : '' }}>Tradisi lisan</option>
                                <option value="Manuskrip" {{ old('jenis_opk') == 'Manuskrip' ? 'selected' : '' }}>Manuskrip</option>
                                <option value="Adat istiadat" {{ old('jenis_opk') == 'Adat istiadat' ? 'selected' : '' }}>Adat istiadat</option>
                                <option value="Ritus" {{ old('jenis_opk') == 'Ritus' ? 'selected' : '' }}>Ritus</option>
                                <option value="Pengetahuan tradisional" {{ old('jenis_opk') == 'Pengetahuan tradisional' ? 'selected' : '' }}>Pengetahuan tradisional</option>
                                <option value="Teknologi tradisional" {{ old('jenis_opk') == 'Teknologi tradisional' ? 'selected' : '' }}>Teknologi tradisional</option>
                                <option value="Seni" {{ old('jenis_opk') == 'Seni' ? 'selected' : '' }}>Seni</option>
                                <option value="Bahasa" {{ old('jenis_opk') == 'Bahasa' ? 'selected' : '' }}>Bahasa</option>
                                <option value="Permainan rakyat" {{ old('jenis_opk') == 'Permainan rakyat' ? 'selected' : '' }}>Permainan rakyat</option>
                                <option value="Olahraga tradisional" {{ old('jenis_opk') == 'Olahraga tradisional' ? 'selected' : '' }}>Olahraga tradisional</option>
                            </select>
                            @error('jenis_opk')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                ...
                <div>
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="tautan_video" id="tautan_video" value="{{ old('tautan_video') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="https://www.youtube.com/...">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="7" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
