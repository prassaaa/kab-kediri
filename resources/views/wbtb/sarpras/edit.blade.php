...
@section('page-title', 'Edit Sarpras Kebudayaan')
...
<div class="bg-white overflow-hidden shadow-sm rounded-lg">
    <div class="p-6">
        ...
        <form action="{{ route('wbtb.sarpras.update', $sarpras->id) }}" method="POST" enctype="multipart/form-data" id="sarpras-form">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_sarpras" id="nama_sarpras" value="{{ old('nama_sarpras', $sarpras->nama_sarpras) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('nama_sarpras')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>{{ old('deskripsi', $sarpras->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>{{ old('alamat', $sarpras->alamat) }}</textarea>
                            @error('alamat')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-2">
                                <div>
                                    ...
                                    <input type="text" name="latitude" id="latitude" value="{{ old('latitude', $sarpras->latitude) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    @error('latitude')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="longitude" id="longitude" value="{{ old('longitude', $sarpras->longitude) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    @error('longitude')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_kontak" id="nama_kontak" value="{{ old('nama_kontak', $sarpras->nama_kontak) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('nama_kontak')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $sarpras->no_hp) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('no_hp')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status_kepemilikan" id="status_kepemilikan" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                ...
                                <option value="Pemerintah" {{ old('status_kepemilikan', $sarpras->status_kepemilikan) == 'Pemerintah' ? 'selected' : '' }}>Pemerintah</option>
                                <option value="Swasta" {{ old('status_kepemilikan', $sarpras->status_kepemilikan) == 'Swasta' ? 'selected' : '' }}>Swasta</option>
                                <option value="Komunitas" {{ old('status_kepemilikan', $sarpras->status_kepemilikan) == 'Komunitas' ? 'selected' : '' }}>Komunitas</option>
                                <option value="Yayasan" {{ old('status_kepemilikan', $sarpras->status_kepemilikan) == 'Yayasan' ? 'selected' : '' }}>Yayasan</option>
                                <option value="Pribadi" {{ old('status_kepemilikan', $sarpras->status_kepemilikan) == 'Pribadi' ? 'selected' : '' }}>Pribadi</option>
                                <option value="Lainnya" {{ old('status_kepemilikan', $sarpras->status_kepemilikan) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_pemilik" id="nama_pemilik" value="{{ old('nama_pemilik', $sarpras->nama_pemilik) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            @error('nama_pemilik')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_pengelola" id="nama_pengelola" value="{{ old('nama_pengelola', $sarpras->nama_pengelola) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            @if($sarpras->papan_nama)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $sarpras->papan_nama) }}" alt="Papan Nama" class="h-20 w-auto">
                                    <p class="text-xs text-gray-500 mt-1">Foto papan nama saat ini</p>
                                </div>
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            @if($sarpras->foto_dalam)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $sarpras->foto_dalam) }}" alt="Foto Dalam" class="h-20 w-auto">
                                    <p class="text-xs text-gray-500 mt-1">Foto bangunan tampak dalam saat ini</p>
                                </div>
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            @if($sarpras->foto_luar)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $sarpras->foto_luar) }}" alt="Foto Luar" class="h-20 w-auto">
                                    <p class="text-xs text-gray-500 mt-1">Foto bangunan tampak luar saat ini</p>
                                </div>
                            @endif
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4" id="fasilitas-container">
                            <div class="fasilitas-items space-y-2">
                                @if($sarpras->fasilitas && count($sarpras->fasilitas) > 0)
                                    @foreach($sarpras->fasilitas as $index => $fasilitas)
                                        <div class="fasilitas-item p-3 border border-gray-300 rounded-md">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" name="fasilitas[{{ $index }}][nama]" value="{{ $fasilitas['nama'] }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Nama fasilitas">
                                            </div>
                                            <div>
                                                <label class="block text-xs text-gray-500 mb-1">Keterangan</label>
                                                <input type="text" name="fasilitas[{{ $index }}][keterangan]" value="{{ $fasilitas['keterangan'] ?? '' }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Keterangan tambahan (opsional)">
                                            </div>
                                            @if($index > 0)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let fasilitasCount = document.querySelectorAll('.fasilitas-item').length;
        ...
        addFasilitasButton.addEventListener('click', function() {
            const newFasilitas = fasilitasTemplate.replace(/fasilitas\[[0-9]+\]/g, `fasilitas[${fasilitasCount}]`);
            fasilitasContainer.insertAdjacentHTML('beforeend', newFasilitas);
            
            // Add remove button to the new item
            const newFasilitasElement = fasilitasContainer.lastElementChild;
            const removeButton = document.createElement('button');
            removeButton.type = 'button';
            removeButton.className = 'remove-item mt-2 text-sm text-red-600 hover:text-red-800';
            removeButton.textContent = 'Hapus';
            removeButton.addEventListener('click', function() {
                newFasilitasElement.remove();
            });
            newFasilitasElement.appendChild(removeButton);
