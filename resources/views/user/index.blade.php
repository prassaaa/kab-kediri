...
<div class="bg-white overflow-hidden shadow-sm rounded-lg">
    <div class="p-6">
        <div class="mb-6">
            <a href="{{ route('user.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center w-fit">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap border-b border-gray-300 text-sm">
                                <div class="flex space-x-2">
                                    <a href="{{ route('user.edit', $user) }}" class="text-indigo-600 hover:text-indigo-900">
